...
uint256 hashGenesisBlock("0x68fde28ad8be229bc4957c42ead63d537231be2a1f299dac7d4cdc4a35093ab3");
...
const string strMessageMagic = "Lcecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // Lacecoin: 0.35 days
static const int64 nTargetSpacing = 15; // Lacecoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal lacecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Lacecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9d798175d44ab3ff27705772a1ce7165ed3812ab4e15507008357684a15d5f8f");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Mon, 12 Jan 2015 15:55:43 GMT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1421091264;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1220693;

        if (fTestNet)
        {
            block.nTime    = 1421078143;
            block.nNonce   = 396282;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x08e7998b66119f2baa4c210cd7c014d5f59842ae7279abfc24eaabb945d6c20f"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // increase each by adding 2 to lacecoin's value.
